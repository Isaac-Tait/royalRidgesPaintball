...
export default function About() {
  return (
    <div className='flex min-h-screen bg-slate-500 flex-col items-center justify-center py-2'>
      <Head>
        <title>Create Next App</title>
        <link rel='icon' href='/favicon.ico' />
      </Head>
      <h1 className='text-6xl absolute top-10  font-extrabold text-violet-500'>
