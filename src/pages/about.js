      ...
      <div className='flex flex-col min-h-screen bg-slate-200 items-center justify-center '>
        ...
        <div className='flex grow items-center justify-center mt-20'>
          ...
          <div className='max-w-5xl mx-auto'>
            ...
            >
              Cras blandit lectus dui, at auctor velit sodales vitae.
              Nam sodales, turpis sit amet ornare feugiat, odio quam
              egestas elit, rhoncus auctor leo tellus nec turpis.
              Aenean non enim iaculis, sollicitudin enim non, commodo
              leo. Nam aliquet molestie risus et imperdiet. Ut
              molestie euismod nulla vel bibendum. Vestibulum ante
              ipsum primis in faucibus orci luctus et ultrices posuere
              cubilia curae; Nam vulputate et libero id bibendum.
              Fusce nibh nulla, molestie non lobortis at, rutrum ac
              orci. Proin porta volutpat ipsum id pulvinar. Nunc
              vulputate ultricies elit. Praesent vel augue justo.
              Mauris fermentum tortor vitae ipsum vestibulum euismod.
              Donec sed risus sit amet justo efficitur rhoncus id in
              nulla. Sed vel volutpat dui. Morbi nulla velit, volutpat
              sed tortor in, aliquet tempor sapien. Sed congue aliquet
              lacinia. Fusce sollicitudin bibendum semper. Nullam quis
              dolor at sem rhoncus sollicitudin. Vestibulum viverra,
              odio vitae facilisis venenatis, mauris est posuere arcu,
              id molestie velit metus viverra ante. Sed id lacus
              faucibus diam mattis dictum. Proin magna nisl, lobortis
              vel pharetra sed, sodales vitae nibh. Sed sodales turpis
              scelerisque, porta felis ut, sodales tellus.
            </p>
          </div>
        </div>
