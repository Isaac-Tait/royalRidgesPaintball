...
export default function Home() {
  return (
    <div className='flex flex-col h-screen bg-slate-200 overflow-y-scroll'>
      {/* Header */}
      <div>
        <p className='font-semibold text-3xl md:text-5xl md:text-center font-sans text-yellow-500 md:pb-4'>
